...
\paragraph{Cart-pole.} Figure \ref{fig:cartpole} compares SVRPG with G(PO)MDP on the continuous cart-pole balancing task. Despite using more trajectories for each parameter, our algorithm shows faster convergence, which can be ascribed to the 
better quality of updates due to variance reduction.
