...
We have already said that as the number of sub-iterations $m$ increases the variance of the importance weights increases too. Therefore, the SVRPG algorithm fails in its primary aim of stabilizing the gradient estimate.
