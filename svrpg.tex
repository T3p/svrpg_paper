...
\begin{figure*}[t]
	...
	\includegraphics[width=.95\textwidth]{images/cart_pole_SVRPG_vs_GPOMDP_tex.pdf}
    ...
    \end{minipage}
    \begin{minipage}[b]{0.3\textwidth}
	\includegraphics[width=0.95\textwidth]{swimmer_self_normalized_SVRPG_vs_SVRPG_tex.pdf}
	...
	\includegraphics[width=0.95\textwidth]{swimmer_self_normalized_SVRPG_vs_GPOMDP_tex.pdf}
