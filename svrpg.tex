...
Despite that, we believe that it will be possible to derive a baseline specifically designed for SVRPG in order to jointly exploit the RL structure and the SVRG idea.
\todomat{Other future work}
