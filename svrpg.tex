...
The idea of SVRG is to alternate full and stochastic gradient updates. Each $m$ iterations, a snapshot $\tilde{\vtheta}$ of the current parameter is saved together with its full gradient $\nabla f(\tilde{\vtheta})$.
