...
\section{Definitions}
We give some additional definitions which will be useful in the proofs of Appendix \ref{app:proofs}.
\begin{definition}
...
We use two auxiliary lemmas, whose proofs are provided later on:
%Lemma 1
