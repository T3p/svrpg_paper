...
\todopir{mention that even if for theoretical guarantees we should return a random solution, this is not a problem for us because we are evaluating the performance on-line. And is always improving}
...
\end{algorithmic}
 ...
 Adam}
\end{algorithm}
\todopir{Explain how we use adam and when/if it is reset on snapshots}
