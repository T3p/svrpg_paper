...
\item \textit{Non-convexity}:
	...
	\begin{assumption}\label{ass:bounded_score}
		...
		\end{align*}
	\end{assumption}
	This property is satisfied by the commonly used Gaussian policy, and is a sufficient condition for the L-smoothness of the objective (see Lemma \ref{lemma:lsmooth} in the appendix).
...
We can now state the following key result (proof in Appendix \ref{app:proofs}):
