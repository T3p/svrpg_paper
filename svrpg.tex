...
{\color{red} Note that the ADAM estimator used in the sub-iterations is reset at each snapshot \todomatout{actually not reset} with the FG estimate (see App.~\ref{app:adam} for details).}
